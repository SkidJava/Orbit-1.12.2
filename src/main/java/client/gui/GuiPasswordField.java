...
public final class GuiPasswordField extends Gui {
    ...
    private int field_146217_k = 255;
    ...
    public void drawTextBox() {
        if (func_146176_q()) {
            if (func_146181_i()) {
                RenderUtils.drawRectangleBorder(this.field_146209_f, this.field_146210_g,
                    this.field_146209_f + this.field_146218_h, this.field_146210_g + this.field_146219_i, 2.0F, -1);
            }
            ...
            if (var4.length() > 0) {
                String var131 = var5 ? var4.substring(0, var2) : var4;
                var9 = this.field_146211_a.drawString(var131.replaceAll(".", "*"), var7, var8, var1);
            }
    ...
    public void drawTextBox1() {
        if (func_146176_q()) {
            if (func_146181_i()) {
                drawRect(this.field_146209_f - 1, this.field_146210_g - 10 - 1,
                    this.field_146209_f + this.field_146218_h + 1,
                    this.field_146210_g - 10 + this.field_146219_i + 1, -6250336);
                drawRect(this.field_146209_f, this.field_146210_g - 10, this.field_146209_f + this.field_146218_h,
                    this.field_146210_g - 10 + this.field_146219_i, -16777216);
            }
            int var1 = this.field_146226_p ? this.field_146222_t : this.field_146221_u;
            int var2 = this.field_146224_r - this.field_146225_q;
            int var3 = this.field_146223_s - this.field_146225_q;
    ...
    private void func_146188_c(int p_146188_1_, int p_146188_2_, int p_146188_3_, int p_146188_4_) {
        ...
        GL11.glEnable(3058);
        GL11.glLogicOp(5387);
        var2.begin(7, DefaultVertexFormats.POSITION_COLOR);
        var2.pos(p_146188_1_, p_146188_4_, 0.0D).color(255, 255, 255, 255).endVertex();
        var2.pos(p_146188_3_, p_146188_4_, 0.0D).color(255, 255, 255, 255).endVertex();
        var2.pos(p_146188_3_, p_146188_2_, 0.0D).color(255, 255, 255, 255).endVertex();
        var2.pos(p_146188_1_, p_146188_2_, 0.0D).color(255, 255, 255, 255).endVertex();
        var2.finishDrawing();
        GL11.glDisable(3058);
        GL11.glEnable(3553);
    }
        ...
        for (int var7 = 0; var7 < var6; var7++) {
            if (!var5) {
                ...
                if (var4 == -1) {
                    ...
                    do {
                        var4++;
                        if ((!p_146197_3_) || (var4 >= var8)) {
                            break;
                        }
                    } while (this.field_146216_j.charAt(var4) == ' ');
                }
            } else {
                do {
                    var4--;
