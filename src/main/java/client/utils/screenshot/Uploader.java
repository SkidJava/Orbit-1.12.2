...
public class Uploader {
    ...
    private final static String CLIENT_ID = "efce6070269a7f1"; // 327537a3680d657
    ...
    private static String getResponse(HttpURLConnection conn) {
        ...
        try {
            if (conn.getResponseCode() != StatusCode.SUCCESS.getHttpCode()) {
                PlayerUtil.tellPlayer(conn.getResponseMessage());
            }
        ...
        if (str.toString().equals("")) {
            PlayerUtil.tellPlayer(StatusCode.UNKNOWN_ERROR.name() + " - " + StatusCode.UNKNOWN_ERROR.getDescription());
        }
        return str.toString();
    }
}
