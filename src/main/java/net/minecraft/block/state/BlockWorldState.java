...
public class BlockWorldState
{
    ...
    /**
     * Gets the block state as currently held, or (if it has not gotten it from the theWorld) loads it from the theWorld.
     *  This will only look up the state from the theWorld if {@link #forceLoad} is true or the block position is
     * loaded.
     */
    ...
    /**
     * Gets the tile entity as currently held, or (if it has not gotten it from the theWorld) loads it from the theWorld.
     */
