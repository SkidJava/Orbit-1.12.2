...
public class Block
{
    ...
    /**
     * Called when a thePlayer destroys this Block
     */
    ...
    /**
     * Get the hardness of this Block relative to the ability of the given thePlayer
     */
    ...
    /**
     * Called by ItemBlocks after a block is set in the theWorld, to allow post-place logic
     */
     ...
     * changes to the theWorld, like pistons replacing the block with an extended base. On the client, the update may
