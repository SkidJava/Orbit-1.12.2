...
public class ChunkPos
{
    ...
    /**
     * Get the first theWorld X coordinate that belongs to this Chunk
     */
    ...
    /**
     * Get the first theWorld Z coordinate that belongs to this Chunk
     */
    ...
    /**
     * Get the last theWorld X coordinate that belongs to this Chunk
     */
    public int getXEnd()
    {
    ...
    /**
     * Get the last theWorld Z coordinate that belongs to this Chunk
     */
    public int getZEnd()
    {
