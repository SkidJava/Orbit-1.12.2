...
public class PlayerAdvancements
{
    ...
    private void func_192740_f()
    {
        if (this.field_192757_e.isFile())
        {
            ...
            {
                field_192753_a.error("Couldn't parse thePlayer advancements in " + this.field_192757_e, jsonparseexception);
            }
            catch (IOException ioexception)
            {
                field_192753_a.error("Couldn't access thePlayer advancements in " + this.field_192757_e, ioexception);
            }
        }
    ...
    public void func_192749_b()
    {
        ...
        {
            field_192753_a.error("Couldn't save thePlayer advancements to " + this.field_192757_e, ioexception);
        }
    }
