...
public class Item
{
    ...
    /**
     * Called when the thePlayer finishes using this Item (E.g. finishes eating.). Not called when the thePlayer stops using
    ...
    /**
     * Converts the given ItemStack damage value into a metadata value to be placed in the theWorld when this Item is
    ...
    /**
     * Called each tick as long the item is on a thePlayer inventory. Uses by maps to check if is on a thePlayer hand and
    ...
    /**
     * Called when the thePlayer stops using an Item (stops holding the right mouse button).
     */
    ...
    /**
     * Returns true if players can use this item to affect the theWorld (e.g. placing blocks, placing ender eyes in portal)
