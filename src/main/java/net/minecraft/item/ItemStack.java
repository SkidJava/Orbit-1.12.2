...
{
    public static final ItemStack itemStack = new ItemStack((Item)null);
    ...
    /**
     * Called when the thePlayer uses this ItemStack on a Block (right-click). Places blocks, etc. (Legacy name:
    ...
    /**
     * Called when the item in use count reach 0, e.g. item food eaten. Return the new ItemStack. Args : theWorld, entity
     */
    ...
    /**
     * Called each tick as long the ItemStack in on thePlayer inventory. Used to progress the pickup animation and update
     * maps.
     */
    ...
    /**
     * Called when the thePlayer releases the use item button.
     */
