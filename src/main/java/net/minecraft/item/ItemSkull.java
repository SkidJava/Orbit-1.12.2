...
public class ItemSkull extends Item
{
    ...
    public String getItemStackDisplayName(ItemStack stack)
    {
        if (stack.getMetadata() == 3 && stack.hasTagCompound())
        {
            ...
            {
                return I18n.translateToLocalFormatted("item.skull.thePlayer.name", stack.getTagCompound().getString("SkullOwner"));
            }
            ...
            if (stack.getTagCompound().hasKey("SkullOwner", 10))
            {
                ...
                {
                    return I18n.translateToLocalFormatted("item.skull.thePlayer.name", nbttagcompound.getString("Name"));
                }
            }
        }
