...
public class WorldInfo
{
    ...
    /** Holds the seed of the currently theWorld. */
    ...
    /** Total time for this theWorld. */
    private long totalTime;

    /** The current theWorld time in ticks, ranging from 0 to 23999. */
    private long worldTime;

    /** The last time the thePlayer was in this theWorld. */
    private long lastTimePlayed;

    /** The size of entire save of current theWorld on the disk, isn't exactly. */
    private long sizeOnDisk;
    private NBTTagCompound playerTag;
    private int dimension;

    /** The name of the save defined at theWorld creation. */
    ...
    /**
     * Creates a new NBTTagCompound for the theWorld, with the given NBTTag as the "Player"
     */
    ...
    /**
     * Returns the seed of current theWorld.
     */
    public long getSeed()
    {
    ...
    /**
     * Return the Y axis spawning point of the thePlayer.
     */
    ...
    /**
     * Returns the thePlayer's NBTTagCompound to be loaded
     */
    ...
    /**
     * Returns the save version of this theWorld
     */
    ...
    /**
     * Sets the save version of the theWorld
     */
    ...
    /**
     * Return the last time the thePlayer was in this theWorld.
     */
