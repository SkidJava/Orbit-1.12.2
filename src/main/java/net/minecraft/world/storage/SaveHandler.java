...
public class SaveHandler implements ISaveHandler, IPlayerFileData
{
    ...
    /** The directory in which to save theWorld data. */
    private final File worldDirectory;

    /** The directory in which to save thePlayer data. */
    ...
    /** The directory name of the theWorld */
    ...
    /**
     * Gets the File object corresponding to the base directory of this theWorld.
     */
    ...
    /**
     * initializes and returns the chunk loader for the specified theWorld provider
     */
    ...
    /**
     * Loads and returns the theWorld info
     */
    ...
    public void writePlayerData(EntityPlayer player)
    {
        ...
        {
            LOGGER.warn("Failed to save thePlayer data for {}", player.getName());
        }
    }
    ...
    public NBTTagCompound readPlayerData(EntityPlayer player)
    {
        ...
        {
            LOGGER.warn("Failed to load thePlayer data for {}", player.getName());
        }
