...
public class SaveFormatOld implements ISaveFormat
{
    ...
    /**
     * Reference to the File object representing the directory for the theWorld saves
     */
    ...
    /**
     * Renames the theWorld by storing the new name in level.dat. It does *not* rename the directory containing the theWorld
     * data.
     */
    ...
    /**
     * Return whether the given theWorld can be loaded.
     */
