...
public abstract class World implements IBlockAccess
{
    ...
    /**
     * holds information about a theWorld (size on disk, time, spawn point, seed, ...)
     */
    protected WorldInfo worldInfo;

    /**
     * if set, this flag forces a request to load a chunk to load the chunk rather than defaulting to the theWorld's
    ...
    /**
     * True if the theWorld is a 'slave' client; changes will not be saved or propagated from this theWorld. For example,
    ...
    /**
     * Creates the chunk provider for this theWorld. Called in the constructor. Retrieves provider from worldProvider?
     */
     ...
     * theWorld. Flags can be added together.
     */
    ...
    /**
     * Performs a raycast against all blocks in the theWorld. Args : Vec1, Vec2, stopOnLiquid,
    ...
    /**
     * Plays the specified sound for a thePlayer at the center of the given block position.
     */
    ...
    /**
     * adds a lightning bolt to the list of lightning bolts in this theWorld.
     */
    ...
    /**
     * Called when an entity is spawned in the theWorld. This includes players.
     */
    ...
    /**
     * Remove a theWorld event listener
     */
    ...
    /**
     * Updates the entity in the theWorld if the chunk the entity is in is currently loaded or its forced to update.
     */
            ...
            for (int l3 = j2; l3 < k2; ++l3)
            {
                for (int i4 = l2; i4 < i3; ++i4)
                {
                    for (int j4 = j3; j4 < k3; ++j4)
                    {
                        ...
                        {
                            double d0 = (double)((float)(i4 + 1) - BlockLiquid.getLiquidHeightPercent(iblockstate1.getValue(BlockLiquid.LEVEL).intValue()));
    ...
    /**
     * Creates an explosion in the theWorld.
     */
    ...
    /**
     * Runs a single tick for the theWorld
     */
    public void tick()
    {
        this.updateWeather();
    ...
    /**
     * Counts how many entities of an entity class exist in the theWorld.
     */
    ...
    /**
     * Gets the closest thePlayer to the entity within the specified distance.
     */
    ...
    {
        return this.getNearestAttackablePlayer((double)((float)pos.getX() + 0.5F), (double)((float)pos.getY() + 0.5F), (double)((float)pos.getZ() + 0.5F), maxXZDistance, maxYDistance, null, null);
    }
    ...
    /**
     * Find a thePlayer by name in this theWorld.
     */
    ...
    /**
     * Gets the spawn point in the theWorld
     */
    ...
    /**
     * gets the theWorld's chunk provider
     */
    ...
    /**
     * Returns this theWorld's current save handler
     */
    ...
    /**
     * Returns the theWorld's WorldInfo object
     */
    ...
    /**
     * Updates the flag that indicates whether or not all players in the theWorld are sleeping.
     */
    ...
    /**
     * Returns maximum theWorld height.
     */
    ...
    /**
     * Returns current theWorld height.
     */
    ...
    /**
     * Adds some basic stats of the theWorld to the given crash report.
     */
