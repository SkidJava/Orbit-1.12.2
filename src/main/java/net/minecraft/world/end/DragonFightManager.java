...
public class DragonFightManager
{
    ...
    public void tick()
    {
        ...
        if (!this.bossInfo.getPlayers().isEmpty())
        {
            ...
            {
                LOGGER.info("Scanning for legacy theWorld dragon fight...");
                this.loadChunks();
                ...
                if (flag)
                {
                    LOGGER.info("Found that the dragon has been killed in this theWorld already.");
                    this.previouslyKilled = true;
                }
                else
                {
                    LOGGER.info("Found that the dragon has not yet been killed in this theWorld.");
