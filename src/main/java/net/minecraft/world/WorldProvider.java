...
public abstract class WorldProvider
{
    ...
    /**
     * States whether the Hell theWorld provider is used(true) or if the normal theWorld provider is used(false)
     */
    protected boolean isHellWorld;

    /**
     * A boolean that tells if a theWorld does not have a sky. Used in calculating weather and skylight
     */
    ...
    /**
     * associate an existing theWorld with a World provider, and setup its lightbrightness table
     */
    ...
    /**
     * creates a new theWorld chunk manager for WorldProvider
     */
    ...
    /**
     * Returns 'true' if in the "main surface theWorld", but 'false' if in the Nether or End dimensions.
     */
    ...
    /**
     * True if the thePlayer can respawn in this dimension (true = overworld, false = nether).
     */
    ...
    /**
     * Called when a Player is added to the provider's theWorld.
     */
    ...
    /**
     * Called when a Player is removed from the provider's theWorld.
     */
    ...
    /**
     * Called when the theWorld is performing a save. Only used to save the state of the Dragon Boss fight in
    ...
    /**
     * Called when the theWorld is updating entities. Only used in WorldProviderEnd to update the DragonFightManager in
     * Vanilla.
     */
