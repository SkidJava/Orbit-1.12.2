...
public class AnvilChunkLoader implements IChunkLoader, IThreadedFileIO
{
    ...
    /**
     * Loads the specified(XZ) chunk into the specified theWorld.
     */
    ...
    /**
     * Save extra data not associated with any Chunk.  Not saved during autosave, only during theWorld unload.  Currently
     * unused.
     */
