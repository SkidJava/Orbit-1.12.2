...
public class WorldServer extends World implements IThreadListener
{
    ...
    /** The entity tracker for this server theWorld. */
    private final EntityTracker theEntityTracker;

    /** The thePlayer chunk map for this server theWorld. */
    ...
    /**
     * Checks if all players in this theWorld are sleeping.
     */
    ...
    /**
     * Creates the bonus chest in the theWorld.
     */
        ...
        else
        {
            ...
            if (this.entitiesByUuid.containsKey(uuid))
            {
                ...
                else
                {
                    ...
                    LOGGER.warn("Force-added thePlayer with duplicate UUID {}", uuid.toString());
                }
    ...
    private void sendQueuedBlockEvents()
    {
        while (!this.blockEventQueue[this.blockEventCacheIndex].isEmpty())
        {
            ...
            for (BlockEventData blockeventdata : this.blockEventQueue[i])
            {
                ...
                {
                    this.mcServer.getPlayerList().sendToAllNearExcept(null, (double)blockeventdata.getPosition().getX(), (double)blockeventdata.getPosition().getY(), (double)blockeventdata.getPosition().getZ(), 64.0D, this.provider.getDimensionType().getId(), new SPacketBlockAction(blockeventdata.getPosition(), blockeventdata.getBlock(), blockeventdata.getEventID(), blockeventdata.getEventParameter()));
                }
            }
    ...
    /**
     * Gets the entity tracker for this server theWorld.
     */
    ...
    /**
     * Gets the thePlayer chunk map for this server theWorld.
     */
