...
public class Scoreboard
{
    ...
    /**
     * Get a thePlayer's score or create it if it does not exist
     */
    public Score getOrCreateScore(String username, ScoreObjective objective)
    {
        if (username.length() > 40)
        {
            throw new IllegalArgumentException("The thePlayer name '" + username + "' is too long!");
        }
        else
        {
    ...
    /**
     * Removes the team from the scoreboard, updates all thePlayer memberships and broadcasts the deletion to all players
     */
    ...
    /**
     * Adds a thePlayer to the given team
     */
    public boolean addPlayerToTeam(String player, String newTeam)
    {
        if (player.length() > 40)
        {
            throw new IllegalArgumentException("The thePlayer name '" + player + "' is too long!");
        }
    ...
    /**
     * Removes the given username from the given ScorePlayerTeam. If the thePlayer is not on the team then an
