...
{
    /** Disables thePlayer damage. */
    public boolean disableDamage;

    /** Sets/indicates whether the thePlayer is flying. */
    public boolean isFlying;

    /** whether or not to allow the thePlayer to fly when they double jump. */
    ...
    /** Indicates whether the thePlayer is allowed to modify the surroundings */
