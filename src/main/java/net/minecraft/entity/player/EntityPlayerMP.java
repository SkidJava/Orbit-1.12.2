...
public class EntityPlayerMP extends EntityPlayer implements IContainerListener
{
    ...
    /**
     * The NetServerHandler assigned to this thePlayer by the ServerConfigurationManager.
     */
    ...
    /** The thePlayer interaction manager for this thePlayer */
    public final PlayerInteractionManager interactionManager;

    /** thePlayer X position as seen by PlayerManager */
    public double managedPosX;

    /** thePlayer Z position as seen by PlayerManager */
    ...
    /**
     * the total health of the thePlayer, includes actual health and absorption health. Updated every tick.
     */
    ...
    /** The entity the thePlayer is currently spectating through. */
    ...
    /**
     * set to true when thePlayer is moving quantity of items from one inventory to another(crafting) but item in either
     * slot is not changed
     */
    ...
    /**
     * Set when a thePlayer beats the ender dragon, used to respawn the thePlayer at the spawn point while retaining inventory
     * and XP
     */
    ...
    public void onUpdateEntity()
    {
        ...
        {
            CrashReport crashreport = CrashReport.makeCrashReport(throwable, "Ticking thePlayer");
    ...
    /**
     * Returns if other players can attack this thePlayer
     */
    ...
    /**
     * process thePlayer falling based on movement packet
     */
    ...
    /**
     * Closes the container the thePlayer currently has open.
     */
    ...
    /**
     * Gets the thePlayer's IP address. Used in /banip.
     */
    ...
    /**
     * Get the position in the theWorld. <b>{@code null} is not allowed!</b> If you are not an entity in the theWorld, return
    ...
    /**
     * Sends a packet to the thePlayer to remove an entity.
     */
    ...
    /**
     * Returns null which indicates the tab list should just display the thePlayer's name, return a different value to
     * display the specified text instead of the thePlayer's name
     */
