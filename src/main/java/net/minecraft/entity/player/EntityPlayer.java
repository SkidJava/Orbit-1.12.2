...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    /** Inventory of the thePlayer */
    public InventoryPlayer inventory = new InventoryPlayer(this);
    protected InventoryEnderChest theInventoryEnderChest = new InventoryEnderChest();

    /**
     * The Container for the thePlayer's inventory (which opens when they press E)
     */
    public Container inventoryContainer;

    /** The Container the thePlayer has open. */
    public Container openContainer;

    /** The food object of the thePlayer, the general hunger logic. */
    protected FoodStats foodStats = new FoodStats();

    /**
     * Used to tell if the thePlayer pressed jump twice. If this is at 0 and it's pressed (And they are allowed to fly, as
     * defined in the thePlayer's movementInput) it sets this to 7. If it's pressed and it's greater than 0 enable fly.
     */
    ...
    /** Boolean value indicating weather a thePlayer is sleeping or not */
    protected boolean sleeping;

    /**
     * The location of the bed the thePlayer is sleeping in, or {@code null} if they are not sleeping
     */
    ...
    /** holds the spawn chunk of the thePlayer */
    private BlockPos spawnChunk;

    /**
     * Whether this thePlayer's spawn point is forced, preventing execution of bed checks.
     */
    private boolean spawnForced;

    /** The thePlayer's capabilities. (See class PlayerCapabilities) */
    public PlayerCapabilities capabilities = new PlayerCapabilities();

    /** The current experience level the thePlayer is on. */
    public int experienceLevel;

    /**
     * The total amount of experience the thePlayer has. This also includes the amount of experience within their
     * Experience Bar.
     */
    public int experienceTotal;

    /**
     * The current amount of experience the thePlayer has within their Experience Bar.
     */
    ...
    /** The thePlayer's unique game profile */
    ...
    public void onUpdate()
    {
        ...
        if (!ItemStack.areItemStacksEqual(this.itemStackMainHand, itemstack))
        {
            ...
            this.itemStackMainHand = itemstack.isEmpty() ? ItemStack.itemStack : itemstack.copy();
        }
    ...
    /**
     * Drops an item into the theWorld.
     */
    ...
    protected void damageShield(float damage)
    {
        if (damage >= 3.0F && this.activeItemStack.getItem() == Items.SHIELD)
        {
            ...
            if (this.activeItemStack.isEmpty())
            {
                ...
                {
                    this.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, ItemStack.itemStack);
                }
                else
                {
                    this.setItemStackToSlot(EntityEquipmentSlot.OFFHAND, ItemStack.itemStack);
                }

                this.activeItemStack = ItemStack.itemStack;
    ...
    /**
     * When searching for vulnerable players, if a thePlayer is invisible, the return value of this is the chance of seeing
     * them anyway.
     */
    ...
    public EnumActionResult func_190775_a(Entity p_190775_1_, EnumHand p_190775_2_)
    {
        ...
        else
        {
            ...
            ItemStack itemstack1 = itemstack.isEmpty() ? ItemStack.itemStack : itemstack.copy();
            ...
            else
            {
                if (!itemstack.isEmpty() && p_190775_1_ instanceof EntityLivingBase)
                {
                    ...
                    if (itemstack.interactWithEntity(this, (EntityLivingBase)p_190775_1_, p_190775_2_))
                    {
                        ...
                        {
                            this.setHeldItem(p_190775_2_, ItemStack.itemStack);
                        }
    ...
    /**
     * Attacks for the thePlayer the targeted entity with the currently equipped item.  The equipped item has hitEntity
                ...
                if (f > 0.0F || f1 > 0.0F)
                {
                    ...
                    if (flag5)
                    {
                        ...
                        if (!itemstack1.isEmpty() && entity instanceof EntityLivingBase)
                        {
                            ...
                            {
                                this.setHeldItem(EnumHand.MAIN_HAND, ItemStack.itemStack);
                            }
                        }
    ...
    /**
     * returns true if this is an EntityPlayerSP, or the logged in thePlayer.
     */
    ...
    /**
     * Returns the GameProfile for this thePlayer
     */
    ...
    /**
     * Wake up the thePlayer if they're sleeping.
     */
    ...
    /**
     * Returns whether thePlayer is sleeping or not
     */
    ...
    /**
     * Returns whether or not the thePlayer is asleep and the screen has fully faded.
     */
    ...
    /**
     * Add experience points to thePlayer.
     */
    ...
    /**
     * Add experience levels to this thePlayer.
     */
     ...
     * experience cap on the thePlayer's experience bar is raised by 10.
     */
    public int xpBarCap()
    {
    ...
    /**
     * Returns the thePlayer's FoodStats object.
     */
    ...
    /**
     * Checks if the thePlayer's health is not full and not zero.
     */
    ...
    /**
     * Only use is to identify if class is an instance of thePlayer for experience dropping
     */
    ...
    /**
     * Sends the thePlayer's abilities to the server (if there is one).
     */
    ...
    /**
     * Sets the thePlayer's game mode and sends it to them.
     */
    ...
    /**
     * Returns the InventoryEnderChest of this thePlayer.
     */
    ...
    public ItemStack getItemStackFromSlot(EntityEquipmentSlot slotIn)
    {
        ...
        {
            return slotIn.getSlotType() == EntityEquipmentSlot.Type.ARMOR ? this.inventory.armorInventory.get(slotIn.getIndex()) : ItemStack.itemStack;
        }
    }
     ...
     * Determines if an entity is visible or not to a specfic thePlayer, if the entity is normally invisible.
    ...
    /**
     * Returns true if the thePlayer is in spectator mode.
     */
    ...
    /**
     * Check whether this thePlayer can open an inventory locked with the given LockCode.
     */
    ...
    /**
     * Whether the "reducedDebugInfo" option is active for this thePlayer.
     */
    ...
    /**
     * Can the thePlayer use command blocks. It checks if the thePlayer is on Creative mode and has permissions (is he OP)
     */
    ...
    {
        return slotIn == 0 ? this.inventory.getCurrentItem() : this.inventory.armorInventory.get(slotIn - 1);
    }
