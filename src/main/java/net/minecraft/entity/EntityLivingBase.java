...
public abstract class EntityLivingBase extends Entity
{
    ...
    private final NonNullList<ItemStack> handInventory = NonNullList.func_191197_a(2, ItemStack.itemStack);
    private final NonNullList<ItemStack> armorArray = NonNullList.func_191197_a(4, ItemStack.itemStack);
    ...
    /**
     * The amount of time remaining this entity should act 'dead', i.e. have a corpse in the theWorld.
     */
    ...
    /** The most recent thePlayer that has attacked this entity */
    protected EntityPlayer attackingPlayer;

    /**
     * Set to 60 when hit by the thePlayer or the thePlayer's wolf, then decrements. Used to determine whether the entity
    ...
    protected ItemStack activeItemStack = ItemStack.itemStack;
    ...
    public void addPotionEffect(PotionEffect potioneffectIn)
    {
        if (this.isPotionApplicable(potioneffectIn))
        {
            ...
            EventUpdatePotionEffect updatePotionEffect;
            ...
            if (potioneffect == null)
            {
                ...
                if(this == Minecraft.getMinecraft().thePlayer) {
                    updatePotionEffect = new EventUpdatePotionEffect(potioneffectIn);
                    updatePotionEffect.call();
                }
            }
            else
            {
                ...
                if(this == Minecraft.getMinecraft().thePlayer) {
                    updatePotionEffect = new EventUpdatePotionEffect(potioneffect);
                    updatePotionEffect.call();
                }
            }
        }
    ...
    /**
     * sets the dead flag. Used when you fall off the bottom of the theWorld.
     */
    protected void kill()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            for (EntityEquipmentSlot entityequipmentslot : EntityEquipmentSlot.values())
            {
                ...
                if (!ItemStack.areItemStacksEqual(itemstack1, itemstack))
                {
                    ...
                    {
                        case HAND:
                            this.handInventory.set(entityequipmentslot.getIndex(), itemstack1.isEmpty() ? ItemStack.itemStack : itemstack1.copy());
                            break;

                        case ARMOR:
                            this.armorArray.set(entityequipmentslot.getIndex(), itemstack1.isEmpty() ? ItemStack.itemStack : itemstack1.copy());
                    }
                }
            }
    ...
    public void onLivingUpdate()
    {
        ...
        this.updateElytra();
        this.func_191986_a(this.moveStrafing, this.moveY, this.moveForward);
        this.world.theProfiler.endSection();
