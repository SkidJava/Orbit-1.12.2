...
public abstract class EntityArrow extends Entity implements IProjectile
{
    ...
    /** 1 if the thePlayer can pick up the arrow */
    ...
    public void readEntityFromNBT(NBTTagCompound compound)
    {
        ...
        else if (compound.hasKey("thePlayer", 99))
        {
            this.pickupStatus = compound.getBoolean("thePlayer") ? EntityArrow.PickupStatus.ALLOWED : EntityArrow.PickupStatus.DISALLOWED;
        }
