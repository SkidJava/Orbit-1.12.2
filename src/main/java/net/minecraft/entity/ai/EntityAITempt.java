...
{
    /** The entity using this AI that is tempted by the thePlayer. */
    private final EntityCreature temptedEntity;
    private final double speed;

    /** X position of thePlayer tempting this mob */
    private double targetX;

    /** Y position of thePlayer tempting this mob */
    private double targetY;

    /** Z position of thePlayer tempting this mob */
    private double targetZ;

    /** Tempting thePlayer's pitch */
    private double pitch;

    /** Tempting thePlayer's yaw */
    private double yaw;

    /** The thePlayer that is tempting the entity that is using this AI. */
