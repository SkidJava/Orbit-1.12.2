...
public class EntityList
{
    ...
    private static final ResourceLocation field_191310_e = new ResourceLocation("thePlayer");
    ...
    /**
     * Create a new instance of an entity in the theWorld by using an entity ID.
     */
