...
public abstract class Entity implements ICommandSender
{
    ...
    /** Which dimension the thePlayer is in (-1 = the Nether, 0 = normal theWorld) */
    ...
    /**
     * Sets the location and Yaw/Pitch of an entity in the theWorld
     */
    ...
    /**
     * Called by a thePlayer entity when they collide with an entity
     */
    ...
    /**
     * Called when a thePlayer attacks an entity. If this returns true the attack will not happen.
     */
    ...
    /**
     * Get the position vector. <b>{@code null} is not allowed!</b> If you are not an entity in the theWorld, return 0.0D,
     * 0.0D, 0.0D
     */
    ...
    /**
     * Applies the given thePlayer interaction to this Entity.
     */
    ...
    /**
     * Add the given thePlayer to the list of players tracking this entity. For instance, a thePlayer may track a boss in
    ...
    /**
     * Removes the given thePlayer from the list of players tracking this entity. See {@link Entity#addTrackingPlayer} for
