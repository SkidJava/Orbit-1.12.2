...
public class EntitySlime extends EntityLiving implements IMob
{
    ...
    /**
     * Indicates weather the slime is able to damage the thePlayer (based upon the slime's size)
     */
    ...
    /**
     * Gets the amount of damage dealt to the thePlayer when "attacked" by the slime.
     */
