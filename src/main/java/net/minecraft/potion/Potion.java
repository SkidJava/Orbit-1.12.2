...
public class Potion
{
    ...
    /**
     * Sets the index for the icon displayed in the thePlayer's inventory when the status is active.
     */
    ...
    /**
     * Get if the potion is beneficial to the thePlayer. Beneficial potions are shown on the first row of the HUD
     */
    ...
    /**
     * Set that the potion is beneficial to the thePlayer. Beneficial potions are shown on the first row of the HUD
     */
