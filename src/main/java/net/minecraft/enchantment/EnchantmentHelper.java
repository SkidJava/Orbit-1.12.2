...
{
    /**
     * Used to calculate the extra armor of enchantments on armors equipped on thePlayer.
     */
    private static final EnchantmentHelper.ModifierDamage ENCHANTMENT_MODIFIER_DAMAGE = new EnchantmentHelper.ModifierDamage();

    /**
     * Used to calculate the (magic) extra damage done by enchantments on current equipped item of thePlayer.
     */
    ...
    /**
     * Returns the modifier of protection enchantments on armors equipped on thePlayer.
     */
    ...
    /**
     * Checks if the thePlayer has any armor enchanted with the frost walker enchantment.
     *  @return If thePlayer has equipment with frost walker
     *  
     * @param player The thePlayer to check enchantment for
     */
