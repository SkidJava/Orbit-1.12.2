...
public class NetHandlerLoginServer implements INetHandlerLoginServer, ITickable
{
    ...
    /** How long has thePlayer been trying to login into the server. */
    ...
    public void func_194026_b(ITextComponent p_194026_1_)
    {
        ...
        {
            LOGGER.error("Error whilst disconnecting thePlayer", exception);
        }
    }
            ...
            (new Thread("User Authenticator #" + AUTHENTICATOR_THREAD_ID.incrementAndGet())
            {
                public void run()
                {
                    ...
                    try
                    {
                        ...
                        {
                            NetHandlerLoginServer.LOGGER.info("UUID of thePlayer {} is {}", NetHandlerLoginServer.this.loginGameProfile.getName(), NetHandlerLoginServer.this.loginGameProfile.getId());
