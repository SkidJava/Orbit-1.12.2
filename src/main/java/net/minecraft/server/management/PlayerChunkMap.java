...
public class PlayerChunkMap
{
    ...
    /**
     * updates all the thePlayer instances that need to be updated
     */
    public void tick()
    {
    ...
    /**
     * Adds an EntityPlayerMP to the PlayerManager and to all thePlayer instances within thePlayer visibility
     */
    ...
    /**
     * Update chunks around a thePlayer that moved
     */
    ...
    /**
     * Get the furthest viewable block given thePlayer's view distance
     */
