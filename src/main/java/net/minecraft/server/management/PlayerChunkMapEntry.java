...
public class PlayerChunkMapEntry
{
    ...
    public void addPlayer(EntityPlayerMP player)
    {
        ...
        {
            LOGGER.debug("Failed to add thePlayer. {} already is in chunk {}, {}", player, Integer.valueOf(this.pos.chunkXPos), Integer.valueOf(this.pos.chunkZPos));
        }
        else
        {
    ...
    /**
     * Provide the chunk at the thePlayer's location. Can fail, returning false, if the thePlayer is a spectator floating
