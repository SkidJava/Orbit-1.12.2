...
{
    /** The theWorld object that this object is connected to. */
    ...
    /** True if the thePlayer is destroying a block */
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    ItemStack itemstack2 = itemstack1.isEmpty() ? ItemStack.itemStack : itemstack1.copy();
    ...
    public EnumActionResult processRightClick(EntityPlayer player, World worldIn, ItemStack stack, EnumHand hand)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if (itemstack.isEmpty())
                {
                    player.setHeldItem(hand, ItemStack.itemStack);
                }
