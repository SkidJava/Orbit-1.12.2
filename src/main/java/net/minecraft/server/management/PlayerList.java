...
public abstract class PlayerList
{
    ...
    /**
     * index into playerEntities of thePlayer to ping, updated every tick; currently hardcoded to max at 200 players
     */
    ...
    public void initializeConnectionToPlayer(NetworkManager netManager, EntityPlayerMP playerIn)
    {
        ...
        if (nbttagcompound != null && nbttagcompound.hasKey("RootVehicle", 10))
        {
            ...
            if (entity1 != null)
            {
                ...
                {
                    LOG.warn("Couldn't reattach entity to thePlayer");
    ...
    /**
     * called during thePlayer login. reads the thePlayer information from disk.
     */
    public NBTTagCompound readPlayerDataFromFile(EntityPlayerMP playerIn)
    {
        ...
        if (playerIn.getName().equals(this.mcServer.getServerOwner()) && nbttagcompound != null)
        {
            ...
            LOG.debug("loading single thePlayer");
        }
        else
        {
    ...
    /**
     * Called when a thePlayer successfully logs in. Reads thePlayer data from disk and inserts the thePlayer into the theWorld.
     */
    ...
    /**
     * Using thePlayer's dimension, update the chunks around them
     */
    ...
    /**
     * Called when a thePlayer disconnects from the game. Writes thePlayer data to disk and removes them from the theWorld.
     */
    public void playerLoggedOut(EntityPlayerMP playerIn)
    {
        ...
        if (playerIn.isRiding())
        {
            ...
            {
                LOG.debug("Removing thePlayer mount");
    ...
    /**
     * Transfers an entity from a theWorld to another theWorld.
     */
    ...
    /**
     * Updates the time and weather for the given thePlayer to those of the given theWorld
     */
    ...
    /**
     * On integrated servers, returns the host's thePlayer data to be written to level.dat.
     */
    ...
    /**
     * Sends the given string to every thePlayer as chat message.
     */
    ...
    /**
     * Get's the EntityPlayerMP object representing the thePlayer with the UUID.
     */
