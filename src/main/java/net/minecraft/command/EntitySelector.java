...
public class EntitySelector
{
    ...
    /**
     * Returns the one thePlayer that matches the given at-token.  Returns null if more than one thePlayer matches.
     */
    ...
    /**
     * Returns whether the given pattern can match more than one thePlayer.
     */
