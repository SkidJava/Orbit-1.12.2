...
import client.event.events.render.EventUpdateScreen;
...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    {
        EventUpdateScreen updateScreen = new EventUpdateScreen(width, height);
        updateScreen.call();
    ...
    {
        this.drawHoveringText(this.renderToolTip(stack), x, y);
    }

    public List<String> renderToolTip(ItemStack itemStack)
    {
        List<String> list = itemStack.getTooltip(this.mc.thePlayer, this.mc.gameSettings.advancedItemTooltips ? ITooltipFlag.TooltipFlags.ADVANCED : ITooltipFlag.TooltipFlags.NORMAL);
    ...
    public void sendChatMessage(String msg, boolean addToChat)
    {
        if (addToChat)
        {
            GuiIngame.getChatGUI().addToSentMessages(msg);
        }
    ...
    /**
     * Called when the GUI is resized in order to update the theWorld and the resolution
     */
