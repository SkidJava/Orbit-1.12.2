...
public class GuiIngame extends Gui
{
    ...
    static GuiNewChat persistantChatGUI;
    ...
    private void renderScoreboard(ScoreObjective objective, ScaledResolution scaledRes)
    {
        ...
        for (Score score1 : collection)
        {
            ...
            int k = j1 - j * this.getFontRenderer().FONT_HEIGHT + (Managers.getManagers().moduleManager.getModule(client.module.render.Scoreboard.class).isEnabled() ?
                    (int) (Managers.getManagers().settingManager.getSetting(client.module.render.Scoreboard.class, "Height").getCurrentValue()) : 0);
            int l = scaledRes.getScaledWidth() - 3 + 2;
            drawRect(l1 - 2, k, l, k + this.getFontRenderer().FONT_HEIGHT, 1342177280);
            this.getFontRenderer().drawString(s1, l1, k, 553648127);
            if (Managers.getManagers().moduleManager.getModule(client.module.render.Scoreboard.class).isEnabled() &&
                Managers.getManagers().settingManager.getSetting(client.module.render.Scoreboard.class, "Draw Int").getBooleanValue()) {
