...
public class GuiStats extends GuiScreen implements IProgressMeter
{
    ...
    protected String screenTitle = "Select theWorld";
    ...
    private void drawSprite(int p_146527_1_, int p_146527_2_, int p_146527_3_, int p_146527_4_)
    {
        ...
        bufferbuilder.pos((double)(p_146527_1_ + 0), (double)(p_146527_2_ + 18), (double) zLevel).tex((double)((float)(p_146527_3_ + 0) * 0.0078125F), (double)((float)(p_146527_4_ + 18) * 0.0078125F)).endVertex();
        bufferbuilder.pos((double)(p_146527_1_ + 18), (double)(p_146527_2_ + 18), (double) zLevel).tex((double)((float)(p_146527_3_ + 18) * 0.0078125F), (double)((float)(p_146527_4_ + 18) * 0.0078125F)).endVertex();
        bufferbuilder.pos((double)(p_146527_1_ + 18), (double)(p_146527_2_ + 0), (double) zLevel).tex((double)((float)(p_146527_3_ + 18) * 0.0078125F), (double)((float)(p_146527_4_ + 0) * 0.0078125F)).endVertex();
        bufferbuilder.pos((double)(p_146527_1_ + 0), (double)(p_146527_2_ + 0), (double) zLevel).tex((double)((float)(p_146527_3_ + 0) * 0.0078125F), (double)((float)(p_146527_4_ + 0) * 0.0078125F)).endVertex();
        tessellator.draw();
    }
