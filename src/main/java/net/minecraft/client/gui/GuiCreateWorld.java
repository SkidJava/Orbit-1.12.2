...
public class GuiCreateWorld extends GuiScreen
{
    ...
    /**
     * Used to save away the game mode when the current "debug" theWorld type is chosen (forcing it to spectator mode)
     */
    ...
    /**
     * Determine a save-directory name from the theWorld name
     */
    ...
    /**
     * Returns whether the currently-selected theWorld type is actually acceptable for selection
     * Used to hide the "debug" theWorld type unless the shift key is depressed.
     */
    ...
    /**
     * Toggles between initial theWorld-creation display, and "more options" display.
    ...
    /**
     * Shows additional theWorld-creation options if toggle is true, otherwise shows main theWorld-creation elements
     */
    ...
    /**
     * Set the initial values of a new theWorld to create, from the values from an existing theWorld.
     *  
