...
public class GuiChat extends GuiScreen implements ITabCompleter
{
    ...
    public void initGui()
    {
        ...
        this.sentHistoryCursor = GuiIngame.getChatGUI().getSentMessages().size();
    ...
    public void onGuiClosed()
    {
        ...
        GuiIngame.getChatGUI().resetScroll();
    }
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        ...
        else if (keyCode != 28 && keyCode != 156)
        {
            ...
            {
                GuiIngame.getChatGUI().scroll(GuiIngame.getChatGUI().getLineCount() - 1);
            }
            else if (keyCode == 209)
            {
                GuiIngame.getChatGUI().scroll(-GuiIngame.getChatGUI().getLineCount() + 1);
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        if (mouseButton == 0)
        {
            ITextComponent itextcomponent = GuiIngame.getChatGUI().getChatComponent(Mouse.getX(), Mouse.getY());
    ...
    public void getSentHistory(int msgPos)
    {
        ...
        int j = GuiIngame.getChatGUI().getSentMessages().size();
        ...
        if (i != this.sentHistoryCursor)
        {
            ...
            else
            {
                ...
                this.inputField.setText(GuiIngame.getChatGUI().getSentMessages().get(i));
    ...
    public static class ChatTabCompleter extends TabCompleter
    {
        ...
        public void complete()
        {
            ...
            if (this.completions.size() > 1)
            {
                ...
                GuiIngame.getChatGUI().printChatMessageWithOptionalDeletion(new TextComponentString(stringbuilder.toString()), 1);
            }
        }
