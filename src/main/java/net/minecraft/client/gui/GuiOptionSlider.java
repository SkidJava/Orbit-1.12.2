...
public class GuiOptionSlider extends GuiButton
{
    ...
    protected void mouseDragged(Minecraft mc, int mouseX, int mouseY)
    {
        if (this.visible)
        {
            ...
            RenderUtils.drawBorderedRect(this.xPosition + (int)(this.sliderValue * (float)(this.width - 8)), this.yPosition, this.xPosition + (int)(this.sliderValue * (float)(this.width - 8)) + 8, this.yPosition + 20, new Color(255, 255, 255).getRGB(), new Color(255, 255, 255).getRGB());
