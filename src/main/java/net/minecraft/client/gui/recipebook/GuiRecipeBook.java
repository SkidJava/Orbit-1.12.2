...
public class GuiRecipeBook extends Gui implements IRecipeUpdateListener
{
    ...
    public void func_194303_a(int p_194303_1_, int p_194303_2_, Minecraft mc, boolean p_194303_4_, InventoryCrafting p_194303_5_)
    {
        this.mc = mc;
        this.field_191904_o = p_194303_1_;
        this.field_191905_p = p_194303_2_;
        this.field_193961_o = p_194303_5_;
        this.recipeBook = mc.thePlayer.getRecipeBook();
        this.field_193966_v = mc.thePlayer.inventory.func_194015_p();
    ...
    public void func_193014_a(boolean p_193014_1_, InventoryCrafting p_193014_2_)
    {
        ...
        this.mc.thePlayer.inventory.func_194016_a(this.field_193965_u, false);
        p_193014_2_.func_194018_a(this.field_193965_u);
        this.field_193962_q = new GuiTextField(0, this.mc.fontRendererObj, i + 25, j + 14, 80, this.mc.fontRendererObj.FONT_HEIGHT + 5);
        ...
        this.field_193022_s.func_194194_a(this.mc, i, j);
        this.field_193022_s.func_193732_a(this);
        this.field_193960_m = new GuiButtonToggle(0, i + 110, j + 12, 26, 16, this.recipeBook.func_192815_c());
    ...
    {
        return this.recipeBook.func_192812_b();
    }

    private void func_193006_a(boolean p_193006_1_)
    {
        this.recipeBook.func_192813_a(p_193006_1_);
    ...
    private void func_193003_g(boolean p_193003_1_)
    {
        ...
        {
            p_193944_1_.func_194210_a(this.field_193965_u, this.field_193961_o.getWidth(), this.field_193961_o.getHeight(), this.recipeBook);
        });
        ...
        if (!s.isEmpty())
        {
            ObjectSet<RecipeList> objectset = new ObjectLinkedOpenHashSet<RecipeList>(this.mc.func_193987_a(SearchTreeManager.field_194012_b).func_194038_a(s.toLowerCase(Locale.ROOT)));
        ...
        if (this.recipeBook.func_192815_c())
        {
    ...
    private void func_193949_f()
    {
        ...
        for (GuiButtonRecipeTab guibuttonrecipetab : this.field_193018_j)
        {
            ...
            {
                guibuttonrecipetab.func_191752_c(i, j + 27 * l++);
                guibuttonrecipetab.func_193918_a(this.mc);
            }
        }
    }
    ...
    public void func_193957_d()
    {
        if (this.func_191878_b())
        {
            if (this.field_193966_v != this.mc.thePlayer.inventory.func_194015_p())
            {
                this.func_193942_g();
                this.field_193966_v = this.mc.thePlayer.inventory.func_194015_p();
            }
        }
    }
    ...
    public void func_191861_a(int p_191861_1_, int p_191861_2_, float p_191861_3_)
    {
        if (this.func_191878_b())
        {
            ...
            this.mc.getTextureManager().bindTexture(field_191894_a);
            ...
            for (GuiButtonRecipeTab guibuttonrecipetab : this.field_193018_j)
            {
                guibuttonrecipetab.drawButton(this.mc, p_191861_1_, p_191861_2_, p_191861_3_);
            }

            this.field_193960_m.drawButton(this.mc, p_191861_1_, p_191861_2_, p_191861_3_);
    ...
    public void func_191876_c(int p_191876_1_, int p_191876_2_, int p_191876_3_, int p_191876_4_)
    {
        if (this.func_191878_b())
        {
            ...
            if (this.field_193960_m.isMouseOver())
            {
                ...
                {
                    this.mc.currentScreen.drawCreativeTabHoveringText(s1, p_191876_3_, p_191876_4_);
                }
            }
    ...
    private void func_193015_d(int p_193015_1_, int p_193015_2_, int p_193015_3_, int p_193015_4_)
    {
        ...
        {
            this.mc.currentScreen.drawHoveringText(this.mc.currentScreen.renderToolTip(itemstack), p_193015_3_, p_193015_4_);
        }
    }

    public void func_191864_a(int p_191864_1_, int p_191864_2_, boolean p_191864_3_, float p_191864_4_)
    {
        this.field_191915_z.func_194188_a(this.mc, p_191864_1_, p_191864_2_, p_191864_3_, p_191864_4_);
    }

    public boolean func_191862_a(int p_191862_1_, int p_191862_2_, int p_191862_3_)
    {
        if (this.func_191878_b() && !this.mc.thePlayer.isSpectator())
        {
            if (this.field_193022_s.func_194196_a(p_191862_1_, p_191862_2_, p_191862_3_, (this.field_191904_o - 147) / 2 - this.field_191903_n, (this.field_191905_p - 166) / 2, 147, 166))
            {
                ...
                if (irecipe != null && recipelist != null)
                {
                    ...
                    this.field_191915_z.func_192682_a();
                    this.mc.playerController.func_194338_a(this.mc.thePlayer.openContainer.windowId, irecipe, GuiScreen.isShiftKeyDown(), this.mc.thePlayer);
            ...
            else if (this.field_193960_m.mousePressed(this.mc, p_191862_1_, p_191862_2_))
            {
                boolean flag = !this.recipeBook.func_192815_c();
                this.recipeBook.func_192810_b(flag);
                this.field_193960_m.func_191753_b(flag);
                this.field_193960_m.playPressSound(this.mc.getSoundHandler());
                this.func_193956_j();
                this.func_193003_g(false);
                return true;
            }
    ...
    public boolean func_193955_c(int p_193955_1_, int p_193955_2_, int p_193955_3_, int p_193955_4_, int p_193955_5_, int p_193955_6_)
    {
        ...
        else
        {
            ...
            return flag && !flag1 && !this.field_191913_x.mousePressed(this.mc, p_193955_1_, p_193955_2_);
        }
    }
    ...
    public boolean func_191859_a(char p_191859_1_, int p_191859_2_)
    {
        if (this.func_191878_b() && !this.mc.thePlayer.isSpectator())
        {
            ...
            {
                if (GameSettings.isKeyDown(this.mc.gameSettings.keyBindChat) && !this.field_193962_q.isFocused())
                {
    ...
    private void func_193716_a(String p_193716_1_)
    {
        if ("excitedze".equals(p_193716_1_))
        {
            ...
            this.mc.fontRendererObj.setUnicodeFlag(this.mc.getLanguageManager().isCurrentLocaleUnicode() || this.mc.gameSettings.forceUnicodeFont);
            this.mc.fontRendererObj.setBidiFlag(languagemanager.isCurrentLanguageBidirectional());
    ...
    public void func_193001_a(List<IRecipe> p_193001_1_)
    {
        ...
        {
            this.mc.thePlayer.func_193103_a(irecipe);
        }
    }
    ...
    private void func_193956_j()
    {
        ...
        {
            this.mc.getConnection().sendPacket(new CPacketRecipeInfo(this.func_191878_b(), this.recipeBook.func_192815_c()));
        }
    }
}
