...
import client.event.events.render.EventChangeScreen;
...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    /** The thePlayer's GameProfile properties */
    ...
    /** True if the thePlayer is connected to a realms server */
    ...
    /**
     * Does the actual gameplay have focus. If so then mouse and keys will effect the thePlayer instead of menus.
     */
    public boolean inGameHasFocus;
    long systemTime = getSystemTime();

    /** Join thePlayer counter */
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle(ClientInfo.getFormatedName());
    ...
    public void displayGuiScreen(@Nullable GuiScreen guiScreenIn)
    {
        ...
        if(Client.getClient() != null) {
            EventChangeScreen updateScreen = new EventChangeScreen(guiScreenIn, currentScreen);
            updateScreen.call();

            if (currentScreen != null && !currentScreen.closed)
                return;

            EventOpenScreen openScreen = new EventOpenScreen(guiScreenIn);
            openScreen.call();
        }
    ...
    /**
     * Resets the thePlayer keystate, disables the ingame focus, and ungrabs the mouse cursor.
     */
        ...
        if (!this.playerController.getIsHittingBlock())
        {
            ...
            if (!this.thePlayer.isRowingBoat())
            {
                ...
                for (EnumHand enumhand : EnumHand.values())
                {
                    ...
                    if (!itemstack.isEmpty() && this.playerController.processRightClick(this.thePlayer, this.theWorld, enumhand) == EnumActionResult.SUCCESS)
                    {
                        this.entityRenderer.itemRenderer.resetEquippedProgress(enumhand);
                        return;
                    }
    ...
    public void runTick() throws IOException
    {
        ...
        if (this.theWorld != null)
        {
            if (!this.isGamePaused)
            {
                ...
                {
                    CrashReport crashreport2 = CrashReport.makeCrashReport(throwable2, "Exception in theWorld tick");
    ...
    private void runTickKeyboard() throws IOException
    {
        while (Keyboard.next())
        {
            ...
            if (flag)
            {
                ...
                EventKeyboard keyboard = new EventKeyboard(i);
                keyboard.call();
    ...
    private boolean processKeyF3(int p_184122_1_)
    {
        ...
        else if (p_184122_1_ == 32)
        {
            ...
            {
                GuiIngame.getChatGUI().clearChatMessages(false);
            }
    ...
    private void processKeyBinds()
    {
        ...
        if (flag2)
        {
            ...
            if (this.currentScreen == null && Keyboard.isKeyDown(Keyboard.KEY_MINUS))
            {
                this.displayGuiScreen(new GuiChat("-"));
            }
    ...
    {
        GuiIngame.getChatGUI().printChatMessage((new TextComponentString("")).appendSibling((new TextComponentTranslation("debug.prefix")).setStyle((new Style()).setColor(TextFormatting.YELLOW).setBold(Boolean.valueOf(true)))).appendText(" ").appendSibling(new TextComponentTranslation(p_190521_1_, p_190521_2_)));
    }
    ...
    /**
     * unloads the current theWorld first
     */
    ...
    /**
     * par2Str is displayed on the loading screen to the user unloads the current theWorld first
     */
    ...
    public void setDimensionAndSpawnPlayer(int dimension)
    {
        ...
        this.renderViewEntity = null;
        EntityPlayerSP thePlayer = this.thePlayer;
        this.thePlayer = this.playerController.func_192830_a(this.theWorld, this.thePlayer == null ? new StatisticsManager() : this.thePlayer.getStatFileWriter(), this.thePlayer == null ? new RecipeBook() : this.thePlayer.getRecipeBook());
        this.thePlayer.getDataManager().setEntryValues(thePlayer.getDataManager().getAll());
    ...
    private void middleClickMouse()
    {
        ...
        {
            EventMiddleClick middleClick = new EventMiddleClick();
            middleClick.call();
            ...
            if (itemstack.isEmpty())
            {
                ...
                if (this.objectMouseOver.typeOfHit == RayTraceResult.Type.BLOCK)
                {
                    s = Block.REGISTRY.getNameForObject(this.theWorld.getBlockState(this.objectMouseOver.getBlockPos()).getBlock()).toString();
                }
    ...
    /**
     * Returns true if there is only one thePlayer playing, and the current server is the integrated one.
     */
    ...
    /**
     * Return the thePlayer's GameProfile properties
     */
        ...
        if (i != 0 && !Keyboard.isRepeatEvent())
        {
            if (!(this.currentScreen instanceof GuiControls) || ((GuiControls)this.currentScreen).time <= getSystemTime() - 20L)
            {
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                        GuiIngame.getChatGUI().printChatMessage(ScreenShotHelper.saveScreenshot(this.mcDataDir, this.displayWidth, this.displayHeight, this.framebufferMc));
                    }
    ...
    /**
     * Return true if the thePlayer is connected to a realms server
     */
    ...
    /**
     * Set if the thePlayer is connected to a realms server
     */
