...
public class DefaultPlayerSkin
{
    ...
    /**
     * Retrieves the default skin for this thePlayer. Depending on the model used this will be Alex or Steve.
     */
    ...
    /**
     * Retrieves the type of skin that a thePlayer is using. The Alex model is slim while the Steve model is default.
     */
