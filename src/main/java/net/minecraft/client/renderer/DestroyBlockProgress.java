...
{
    /**
     * entity ID of the thePlayer associated with this partially destroyed Block. Used to identify the Blocks in the client
     * Renderer, max 1 per thePlayer on a server
     */
