...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    /**
     * Changes the field of view of the thePlayer depending on if they are underwater or not
     */
    ...
    private void hurtCameraEffect(float partialTicks)
    {
        ...
        {
            EventHurtCam hurtCam = new EventHurtCam();
            hurtCam.call();
    ...
    /**
     * Updates the bobbing render effect of the thePlayer.
     */
    ...
    /**
     * sets up thePlayer's eye (or camera in third person mode)
     */
            ...
            else
            {
                ...
                for (int i = 0; i < 8; ++i)
                {
                    ...
                    if (raytraceresult != null)
                    {
                        ...
                        if (d7 < d3 && !(Managers.getManagers().moduleManager.getModule(ViewClip.class).isEnabled()) )
                        {
                            d3 = d7;
                        }
                    }
...
//            GlStateManager.scale(1.0F / f2, 1.0F, 1.0F);
            if (Managers.getManagers().moduleManager.getModule(AntiFC.class).isEnabled()) {
                ...
                if (blockpos1.getY() <= blockpos.getY() + 10 && blockpos1.getY() >= blockpos.getY() - 10 && biome.canRain() && biome.getFloatTemperature(blockpos1) >= 0.15F)
                {
                    ...
                    if (iblockstate.getMaterial() != Material.LAVA && iblockstate.getBlock() != Blocks.MAGMA)
                    {
                        if (iblockstate.getMaterial() != Material.AIR)
                        {
                            ...
                            this.mc.theWorld.spawnParticle(EnumParticleTypes.WATER_DROP, (double)blockpos2.getX() + d3, (double)((float)blockpos2.getY() + 0.1F) + axisalignedbb.maxY, (double)blockpos2.getZ() + d4, 0.0D, 0.0D, 0.0D);
                        }
                    }
                    else
                    {
                        this.mc.theWorld.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, (double)blockpos1.getX() + d3, (double)((float)blockpos1.getY() + 0.1F) - axisalignedbb.minY, (double)blockpos1.getZ() + d4, 0.0D, 0.0D, 0.0D);
                    }
                }
            }
    ...
    private void updateFogColor(float partialTicks)
    {
        ...
        else if (Reflector.ForgeBlock_getFogColor.exists())
        {
            ...
            IBlockState iblockstate = this.mc.theWorld.getBlockState(blockpos);
            Vec3d vec3d3 = (Vec3d)Reflector.call(iblockstate.getBlock(), Reflector.ForgeBlock_getFogColor, this.mc.theWorld, blockpos, iblockstate, entity, new Vec3d((double)this.fogColorRed, (double)this.fogColorGreen, (double)this.fogColorBlue), partialTicks);
        ...
        else if (iblockstate1.getMaterial() == Material.WATER)
        {
            ...
            Vec3d vec3d7 = CustomColors.getUnderwaterColor(this.mc.theWorld, this.mc.getRenderViewEntity().posX, this.mc.getRenderViewEntity().posY + 1.0D, this.mc.getRenderViewEntity().posZ);
        ...
        else if (iblockstate1.getMaterial() == Material.LAVA)
        {
            ...
            Vec3d vec3d6 = CustomColors.getUnderlavaColor(this.mc.theWorld, this.mc.getRenderViewEntity().posX, this.mc.getRenderViewEntity().posY + 1.0D, this.mc.getRenderViewEntity().posZ);
    ...
    private void frameInit()
    {
        ...
        if (world != null)
        {
            if (Config.getNewRelease() != null)
            {
                ...
                GuiIngame.getChatGUI().printChatMessage(textcomponentstring);
            ...
            if (Config.isNotify64BitJava())
            {
                ...
                GuiIngame.getChatGUI().printChatMessage(textcomponentstring1);
            }
        }
    ...
    private void checkLoadVisibleChunks(Entity p_checkLoadVisibleChunks_1_, float p_checkLoadVisibleChunks_2_, ICamera p_checkLoadVisibleChunks_3_, boolean p_checkLoadVisibleChunks_4_)
    {
        ...
        if (this.loadVisibleChunks)
        {
            ...
            GuiIngame.getChatGUI().deleteChatLine(i);
        }
        ...
        if (Keyboard.isKeyDown(61) && Keyboard.isKeyDown(38))
        {
            ...
            GuiIngame.getChatGUI().printChatMessageWithOptionalDeletion(textcomponentstring, i);
