...
public class ItemRenderer
{
    ...
    /**
     * Renders the active item in the thePlayer's hand when in first person mode.
     */
    ...
    /**
     * Render the block in the thePlayer's hand
     */
    ...
    /**
     * Renders a texture that warps around based on the direction the thePlayer is looking. Texture needs to be bound
