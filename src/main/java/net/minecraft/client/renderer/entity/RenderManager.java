...
public class RenderManager
{
    ...
    public void doRenderEntity(Entity entityIn, double x, double y, double z, float yaw, float partialTicks, boolean p_188391_10_)
    {
        ...
        try
        {
            ...
            if (render != null && this.renderEngine != null)
            {
                ...
                {
                    throw new ReportedException(CrashReport.makeCrashReport(throwable2, "Rendering entity in theWorld"));
                }
                ...
                {
                    throw new ReportedException(CrashReport.makeCrashReport(throwable1, "Post-rendering entity in theWorld"));
                }
                ...
                if (this.debugBoundingBox && !entityIn.isInvisible() && !p_188391_10_ && !Minecraft.getMinecraft().isReducedDebug())
                {
                    ...
                    {
                        throw new ReportedException(CrashReport.makeCrashReport(throwable, "Rendering entity hitbox in theWorld"));
                    }
                }
            }
        }
        ...
        {
            CrashReport crashreport = CrashReport.makeCrashReport(throwable3, "Rendering entity in theWorld");
    ...
    /**
     * World sets this RenderManager's worldObj to the theWorld provided
     */
