...
public class TileEntityRendererDispatcher
{
    ...
    /** The thePlayer's current X position (same as playerX) */
    public static double staticPlayerX;

    /** The thePlayer's current Y position (same as playerY) */
    public static double staticPlayerY;

    /** The thePlayer's current Z position (same as playerZ) */
