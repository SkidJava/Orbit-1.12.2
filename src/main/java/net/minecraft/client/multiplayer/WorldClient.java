...
public class WorldClient extends World
{
    ...
    {
        int i = MathHelper.floor(this.mc.thePlayer.posX / 16.0D);
        int j = MathHelper.floor(this.mc.thePlayer.posZ / 16.0D);
        ...
        if (i != this.playerChunkX || j != this.playerChunkY)
        {
            ...
            int l = MathHelper.floor(this.mc.thePlayer.posX / 16.0D);
            int i1 = MathHelper.floor(this.mc.thePlayer.posZ / 16.0D);
