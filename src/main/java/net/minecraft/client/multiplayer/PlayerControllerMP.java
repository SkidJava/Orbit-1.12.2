...
public class PlayerControllerMP
{
    ...
    private ItemStack currentItemHittingBlock = ItemStack.itemStack;
    ...
    /** Tells if the thePlayer is hitting a block */
    public boolean isHittingBlock;

    /** Current game type for the thePlayer */
    private GameType currentGameType = GameType.SURVIVAL;

    /** Index of the current item held by the thePlayer in the inventory hotbar */
    ...
    /**
     * Sets thePlayer capabilities depending on current gametype. params: thePlayer
     */
    ...
    /**
     * Sets the game type for the thePlayer.
     */
    ...
    public boolean onPlayerDestroyBlock(BlockPos pos)
    {
        ...
        if (this.currentGameType.isCreative() && !this.mc.thePlayer.getHeldItemMainhand().isEmpty() && this.mc.thePlayer.getHeldItemMainhand().getItem() instanceof ItemSword)
        {
            return false;
        }
        else
            ...
            else
            {
                ...
                if (!this.currentGameType.isCreative())
                {
                    ...
                    if (!itemstack1.isEmpty())
                    {
                        ...
                        if (itemstack1.isEmpty())
                        {
                            this.mc.thePlayer.setHeldItem(EnumHand.MAIN_HAND, ItemStack.itemStack);
                        }
                    }
                }
    ...
    /**
     * Called when the thePlayer is hitting a block with an item.
     */
    public boolean clickBlock(BlockPos loc, EnumFacing face)
    {
        ...
        else
        {
            ...
            else if (!this.isHittingBlock || !this.isHittingPosition(loc))
            {
                ...
                if (flag && iblockstate.getPlayerRelativeBlockHardness(this.mc.thePlayer, this.mc.thePlayer.world, loc) >= 1.0F)
                {
    ...
    public boolean onPlayerDamageBlock(BlockPos posBlock, EnumFacing directionFacing)
    {
        ...
        else if (this.isHittingPosition(posBlock))
        {
            ...
            {
                this.curBlockDamageMP += iblockstate.getPlayerRelativeBlockHardness(this.mc.thePlayer, this.mc.thePlayer.world, posBlock);
                ...
                this.mc.func_193032_ao().func_193294_a(this.mc.theWorld, posBlock, iblockstate, MathHelper.clamp(this.curBlockDamageMP, 0.0F, 1.0F));
    ...
    /**
     * Syncs the current thePlayer item with the server
     */
     ...
     * enchantment action the thePlayer has taken.
     */
    ...
    /**
     * Checks if the thePlayer is not creative, used for checking if it should break a block instantly
     */
    ...
    /**
     * returns true if thePlayer is in creative mode
     */
    ...
    /**
     * Checks if the thePlayer is riding a horse, used to chose the GUI to open
     */
