 ...
 *         <li>{@link #getAll(Iterable, Predicate)}
 *     </ul>
...
public abstract class ReflectionUtils {
    ...
    public static List<Class> getPrimitiveTypes() {
        return primitiveTypes == null ? (primitiveTypes = Lists.newArrayList(boolean.class, char.class, byte.class, short.class, int.class, long.class, float.class, double.class, void.class)) : primitiveTypes;
    }
