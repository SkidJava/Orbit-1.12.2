...
public class Reflector
{
    ...
    public static ReflectorClass ChunkWatchEvent_UnWatch = new ReflectorClass("net.minecraftforge.event.theWorld.ChunkWatchEvent$UnWatch");
    ...
    public static ReflectorClass WorldEvent_Load = new ReflectorClass("net.minecraftforge.event.theWorld.WorldEvent$Load");
