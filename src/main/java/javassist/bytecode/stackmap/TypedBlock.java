...
public class TypedBlock extends BasicBlock
{
    ...
    // localsTypes is set to non-null when this blocks is first visited by a MapMaker.
    // see alreadySet().
     ...
     * The type information of the first blocks is initialized.
     *
    ...
    /**
     * Initializes the first blocks by the given method descriptor.
     *
     * @param block             the first basic blocks that this method initializes.
